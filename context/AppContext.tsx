...
export const currencies = [
  ...
  { code:"JPY", symbol:"¥",   name:"Japanese Yen",        noDecimal:true },
  { code:"CNY", symbol:"¥",   name:"Chinese Yuan" },
  { code:"KRW", symbol:"₩",   name:"Korean Won",           noDecimal:true },
  { code:"SGD", symbol:"S$",  name:"Singapore Dollar" },
  { code:"MYR", symbol:"RM",  name:"Malaysian Ringgit" },
  { code:"IDR", symbol:"Rp",  name:"Indonesian Rupiah",    noDecimal:true },
  { code:"VND", symbol:"₫",   name:"Vietnamese Dong",      noDecimal:true },
  { code:"INR", symbol:"₹",   name:"Indian Rupee",         indianComma:true },
  ...
  { code:"PKR", symbol:"₨",   name:"Pakistani Rupee",      indianComma:true },
  { code:"BDT", symbol:"৳",   name:"Bangladeshi Taka",     indianComma:true },
